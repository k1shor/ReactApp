      ...
      <div className="container-fluid">
        <footer className="py-5">
          ...
          <div className="d-flex justify-content-between py-4 my-4 border-top">
            ...
            <ul className="list-unstyled d-flex custom-iconbar">
              <li className="ms-3"><Link className="link fs-4 text-white" to="#"><i class="fab fa-facebook"></i></Link></li>
              <li className="ms-3"><Link className="link fs-4 text-white" to="#"><i class="fab fa-twitter"></i></Link></li>
              <li className="ms-3"><Link className="link fs-4 text-white" to="#"><i class="fab fa-instagram"></i></Link></li>
            </ul>
          </div>
        </footer>
      </div>
